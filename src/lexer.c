...
char* keywords[NO_OF_KEYWORDS] = {
    ...
    "if", "elif", "else", "for", "while", "switch", "case", "try", "except", "finally", "break", "continue", "err", "throw"
};
...
Token* lexer_handle_alpha(Lexer* lexer) {
    ...
    */
    ...
    uint8_t KWCHAR_TYPE_MAP[NO_OF_KEYWORDS] = {
        ...
        TOK_IF, TOK_ELIF, TOK_ELSE, TOK_FOR, TOK_WHILE, TOK_SWITCH, TOK_CASE, TOK_TRY, TOK_EXCEPT, TOK_FINALLY, TOK_BREAK, TOK_CONTINUE, TOK_ERR, TOK_THROW
    };
